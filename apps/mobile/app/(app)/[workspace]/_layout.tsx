...
import { usePrefetchWorkspaceTabs } from "@/lib/use-prefetch-workspace-tabs";
...
export default function WorkspaceLayout() {
  ...
  // Warm the three bottom-tab lists once the workspace resolves, so the
  // lazily-mounted tabs don't each pay a cold fetch on first focus.
  usePrefetchWorkspaceTabs(matched?.id ?? null);
