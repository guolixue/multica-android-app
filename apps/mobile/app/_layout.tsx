...
export default function RootLayout() {
  ...
  // (see ensureQueryCacheRestored in data/query-client.ts). The AsyncStorage
  // read is fast (tens of ms) — the tradeoff is worth it.
  const [cacheReady, setCacheReady] = useState(false);
  useEffect(() => {
    void ensureQueryCacheRestored().finally(() => setCacheReady(true));
  }, []);
