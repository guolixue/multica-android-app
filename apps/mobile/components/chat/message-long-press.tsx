        ...
        switch (action.kind) {
          ...
          case "select":
            if (Platform.OS === "android") {
              // The markdown renderer's Android native view can't surface
              // in-place long-press text selection (a LinkMovementMethod
              // override swallows it), so present the message as a plain
